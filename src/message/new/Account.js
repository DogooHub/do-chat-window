...
import {BASE_PATH, getAllAccounts} from "../../services/axios";
import {useChatWindowContext} from "../../index";
import {utf8ToAscii} from "../../services/utils";
...
const DGSelectAccount = ({selectedAccounts = [], onChangeAccount}) => {
    ...
    const {axios,BASE_PATH} = useChatWindowContext();
    ...
    function initialOptions() {
        getAllAccounts(axios, "status eq 'approved'", 1, Number.MAX_SAFE_INTEGER, null, null).then(
            (response) => {
